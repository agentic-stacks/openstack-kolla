...
**Action:** No immediate action required for existing OVS deployments. Plan migration to OVN for a future upgrade cycle. See `skills/reference/decision-guides/networking.md` for migration guidance.
